const text = [
  ...
  dummyText = document.querySelector('.lorem-text');
  ...
  function generateRandom()
  {
     ...
     dummyText.innerHTML = `<p class="dummy-text">${msg}</p>` 
  }

  function generateDummyText(value)
  {
let tempText = text.slice(0,value);
tempText = tempText.map((text)=>{
  return ` <p class="dummy-text">
       ${text}
  </p>` 

}).join("")

dummyText.innerHTML = tempText
}